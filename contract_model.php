...
<body>
    ...
    <p>The following model was established by the Walloon Government in execution of article 3, § 4, of the decree of March 15
        ...
        well-known provisions of practice, which concern non-regulated subjects.</p>
    <h2>Tenant informations</h2>
    <p>Name : <span class="user-data"><?php echo $name; ?></span></p>
    <p>Current adress : <span class="user-data"><?php echo $address; ?></span></p>
    <p>Email address : <span class="user-data"><?php echo $email; ?></span></p>
    <p>Phone number : <span class="user-data"><?php echo $phone; ?></span></p>
    <h2>Owner informations</h2>
    <p>Name : Bruce Springsteen</p>
    <p>Address of the property : 89, Avenue François Mitterrand 62930 Wimereux</p>
    <p>Email : bruce.s@gmail.com</p>
