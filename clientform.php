  ...
  <body>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center align-items-center vh-100">
            <div class="col-lg-4">
                <h2 class="text-center fs-1">Fill this form</h2>
                <form class="mt-4" action="treatment.php" method="POST">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="address" placeholder="Enter your message here..." style="height: 6rem" required></input>
